...
export default function InmateShowPopup() {
  ...
  return (
    <>
        ...
        <button onClick={OpenDialogue} className='absolute top-0 flex px-2 py-1.5 bg-zinc-50 rounded-lg border items-center space-x-3 w-full hover:bg-stone-300 hover:border-slate-400 cursor-pointer'>
            ...
            <span className="text-sm text-slate-400 font-semibold">Eg:sfsfaf</span>
        </button>    
      ...
      <Transition appear show={IsOpen} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={CloseDialogue}>
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="fixed inset-0 backdrop-blur-sm bg-blue-400/20" />
          </Transition.Child>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center ">
              ...
              >
                <Dialog.Panel className="absolute top-0 mt-20 w-80 px-4 transform overflow-hidden rounded-xl bg-white transition-all">
                    <section className='pt-2 pb-6 space-y-6 w-full relative'>
                        <div onClick={CloseDialogue} className="absolute mt-2 top-0 right-0 p-2 rounded-full items-center justify-center hover:border hover:bg-slate-200">
                        ...
                        <div className="w-40 border-b-2 border-fuchsia-600 p-1 grow-0 mt-2">
                            <p className="text-slate-700 text-md font-semibold">Personal Information</p>
                        </div>

                        <article className="flex flex-col space-y-2 pr-10">
                            <span className="flex items-center justify-between">
                                <p className="text-slate-500 text-sm font-normal">Prisoner ID:</p>    
                                <p className="text-slate-700 text-base font-semibold">WIN-0243</p>    
                            </span>    
                            <span className="flex justify-between items-center">
                                <p className="text-slate-500 text-sm font-normal">Full Name:</p>    
                                <p className="text-slate-700 text-base font-semibold">Simon Tchalla</p>    
                            </span>    
                            <span className="flex justify-between items-center">
                                <p className="text-slate-500 text-sm font-normal">Date of Birth:</p>    
                                <p className="text-slate-700 text-base font-semibold">8th March 2004</p>    
                            </span>    
                            <span className="flex justify-between items-center">
                                <p className="text-slate-500 text-sm font-normal">Date of Conviction:</p>    
                                <p className="text-slate-700 text-base font-semibold">8th March 2004</p>    
                            </span>    
                            <span className="flex justify-between items-center">
                                <p className="text-slate-500 text-sm font-normal">Cell Number:</p>    
                                <p className="text-slate-700 text-base font-semibold">CELL-024</p>    
                            </span>    
